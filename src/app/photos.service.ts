...
export class PhotosService {
  private photoSets = [
    ...
    [
      ...
      {
        id: 8,
        url: 'https://images.unsplash.com/photo-1550330039-a54e15ed9d33?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60',
      },
    ],
    [
      {
    ...
    [
      {
        id: 11,
        url: 'https://images.unsplash.com/photo-1549985908-597a09ef0a7c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60',
      },
      {
        id: 12,
  ...
  getPhotos(): Observable<any[]> {
    return of(this.photoSets[this.currentSetIndex]);
  }

  loadNextSet(): Observable<any[]> {
    this.currentSetIndex = (this.currentSetIndex + 1) % this.photoSets.length;
    return of(this.photoSets[this.currentSetIndex]);
  }
}
